...
var _searchCountry = require("./js/searchCountry");

},{"./js/fetchCountries":"LnPoi","./js/searchCountry":"b4oja"}],"LnPoi":[function(require,module,exports,__globalThis) {
...
function fetchCountries(name) {
    ...
    return fetch(url).then((response)=>{
        if (response.status === 404) return Promise.reject("\u041A\u0440\u0430\u0457\u043D\u0443 \u043D\u0435 \u0437\u043D\u0430\u0439\u0434\u0435\u043D\u043E");
...
},{}],"b4oja":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function onInput(e) {
    ...
    (0, _fetchCountriesDefault.default)(name).then(showResult).catch(()=>{
        clearAll();
        (0, _core.alert)({
...
function showResult(countries) {
    ...
    if (countries.length === 1) {
      ...
      <img src="${country.flags.svg}" alt="\u{41F}\u{440}\u{430}\u{43F}\u{43E}\u{440} ${country.name}">
    `;
        return;
    }
    list.innerHTML = countries.map((country)=>`<li>${country.name}</li>`).join('');
}
function clearAll() {
    list.innerHTML = '';
    infoBox.innerHTML = '';
...
},{"./fetchCountries":"LnPoi","lodash.debounce":"irvaP","@pnotify/core":"fay4s","@pnotify/core/dist/PNotify.css":"c4y47","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"irvaP":[function(require,module,exports,__globalThis) {
/**
...
},{}],"c4y47":[function() {},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequire8075", {})

//# sourceMappingURL=home-work-15.4.31b563d9.js.map
